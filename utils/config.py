...
class ConfigManager:
    ...
    def open_hotel_foodie(self):
        return self.config.getboolean("Settings", "open_hotel_foodie", fallback=True)

    @property
    def open_hotel_fofa(self):
        return self.config.getboolean("Settings", "open_hotel_fofa", fallback=False)
    ...
    def hotel_region_list(self):
        return self.config.get("Settings", "hotel_region_list", fallback="全部").split(",")

    @property
    def open_multicast(self):
        return self.config.getboolean("Settings", "open_multicast", fallback=False)

    @property
    def open_multicast_foodie(self):
        return self.config.getboolean("Settings", "open_multicast_foodie", fallback=True)

    @property
    def open_multicast_fofa(self):
        return self.config.getboolean("Settings", "open_multicast_fofa", fallback=False)
    ...
    def multicast_region_list(self):
        return self.config.get("Settings", "multicast_region_list", fallback="全部").split(",")

    @property
    def open_online_search(self):
        return self.config.getboolean("Settings", "open_online_search", fallback=False)

    @property
    def online_search_num(self):
        return self.config.getint("Settings", "online_search_num", fallback=0)
    ...
    def open_driver(self):
        return self.config.getboolean("Settings", "open_driver", fallback=False)
    ...
    @property
    def app_host(self):
        return self.config.get("Settings", "app_host", fallback="http://localhost")
    ...
    def nginx_http_port(self):
        return self.config.getint("Settings", "nginx_http_port", fallback=51888)
