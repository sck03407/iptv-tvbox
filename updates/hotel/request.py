    ...
    if config.open_request:
        ...
        def process_region_by_hotel(region):
            ...
            try:
                ...
                if callback:
                    callback(
                        t("msg.task_hotel_foodie_remaining").format(remaining=region_list_len - pbar.n, time=get_pbar_remaining(n=pbar.n, total=pbar.total, start_time=start_time)),
        ...
        if callback:
            callback(t("msg.task_hotel_foodie").format(region=region_list_len), 0)
